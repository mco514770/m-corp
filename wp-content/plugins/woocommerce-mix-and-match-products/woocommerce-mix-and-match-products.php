...
class WC_Mix_and_Match {
	...
	public function initialize_plugin() {
		...
		if ( ! defined( 'WC_VERSION' ) || version_compare( WC_VERSION, $this->required_woo, '<' ) ) {
			$notice = sprintf( __( '<strong>WooCommerce Mix and Match is inactive.</strong> The %sWooCommerce plugin%s must be active and at least version %s for Mix and Match to function. Please upgrade or activate WooCommerce.', 'woocommerce-mix-and-match-products' ), '<a href="http://wordpress.org/extend/plugins/woocommerce/">', '</a>', $this->required_woo );
	...
	public function admin_notice() {
	    ...
	    echo '<div class="error"><p>' . sprintf( __( '<strong>WooCommerce Mix and Match is inactive.</strong> The %sWooCommerce plugin%s must be active and at least version %s for Mix and Match to function. Please upgrade or activate WooCommerce.', 'woocommerce-mix-and-match-products' ), '<a href="http://wordpress.org/extend/plugins/woocommerce/">', '</a>', $this->required_woo ) . '</p></div>';
	}
