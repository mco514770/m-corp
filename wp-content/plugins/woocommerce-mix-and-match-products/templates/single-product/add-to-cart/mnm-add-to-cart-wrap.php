...
if ( $product->is_purchasable() && $product->is_in_stock() ) { ?>
	...
	<?php
		...
		<div class="mnm_button_wrap" style="display:block">
			...
			<button type="submit" class="single_add_to_cart_button mnm_add_to_cart_button button alt" data-product_id="<?php echo esc_attr( $product->get_id() ); ?>"><?php echo $product->single_add_to_cart_text(); ?></button>
