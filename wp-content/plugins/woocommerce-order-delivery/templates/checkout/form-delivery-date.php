...
<div id="wc-od">
	...
	<?php if ( 'calendar' === $delivery_option ) : ?>
		...
		<p><?php echo wp_kses_post( __( 'Please select a date for your order. Toronto deliveries are made by our couriers on the selected delivery date. For Canada/US shipping orders, the selected date is when cookies will ship out. Shipping arrival dates are determined by Canada Post/USPS services.', 'woocommerce-order-delivery' ) ); ?></p>
