...
<div style="margin-bottom:40px;">
	...
	<?php
		...
		printf( wp_kses_post( __( 'We will deliver/ship out your order on %s. If you chose shipping via Canada Post, you will receive tracking updates via email.', 'woocommerce-order-delivery' ) ), "<strong>{$delivery_date}</strong>" ); // WPCS: XSS ok.
	?>
	</p>
