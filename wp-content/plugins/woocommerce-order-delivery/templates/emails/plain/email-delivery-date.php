...
echo sprintf( esc_html__( 'We will deliver/ship out your order on %s. If you chose shipping via Canada Post, you will receive tracking updates via email.', 'woocommerce-order-delivery' ), $delivery_date ) . "\n"; // WPCS: XSS ok.
