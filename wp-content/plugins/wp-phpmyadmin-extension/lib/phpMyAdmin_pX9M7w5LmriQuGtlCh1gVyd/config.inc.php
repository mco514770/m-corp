...
$cfg['blowfish_secret']					= '<knr,Wuz7+C)[-HIs4p!zf(Q,1Ik^`P#' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_pX9M7w5LmriQuGtlCh1gVyd/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://staging11.thenightbaker.com/wp-admin/?rand=8221823&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://staging11.thenightbaker.com/wp-admin/?rand=13096855&pma_logout=1';
